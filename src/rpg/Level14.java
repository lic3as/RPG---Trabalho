...
public class Level14 extends javax.swing.JFrame {

    public Level14() {
        initComponents();
        setTitle("Super Mario - Level 14");
        setSize(790,480);
        //largura, altura//
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fases/fase14.png"))); // NOI18N
        getContentPane().add(jLabel2);
        jLabel2.setBounds(10, 10, 520, 100);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/respostas/resposta 14.png"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/respostas/resposta 14 b.png"))); // NOI18N
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        ...
        JOptionPane.showMessageDialog(null,"Isso mesmo. Bowser saiu e você conseguiu resgatar a princesa, \n ainda precisam conseguir sair do castelo e derrotar Bowser. Boa sorte!");
        dispose();
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        JOptionPane.showMessageDialog(null,"Calma... Antes de tudo, tente salvar a princesa \npois se perder essa luta eles podem fazer coisas piores com ela. GAME OVER.");
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Level14.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
